...
class Player(tk.Frame):
	...
	def create_frames(self):
		...
		self.track.config(width=800,height=440)
	...
	def control_widgets(self):
		self.loadSongs = tk.Button(self.controls, bg='sky blue', fg='black', font=10)
		self.loadSongs['text'] = 'Browse songs'
		self.loadSongs['command'] = self.retrieve_songs
		self.loadSongs.grid(row=0, column=0, padx=15)
...
img = PhotoImage(file="D://Projects//Music Player//Music Player//images//new.png")
next_ = PhotoImage(file="D://Projects//Music Player//Music Player//images//next.gif")
prev = PhotoImage(file="D://Projects//Music Player//Music Player//images//previous.gif")
play = PhotoImage(file="D://Projects//Music Player//Music Player//images//play.gif")
pause = PhotoImage(file="D://Projects//Music Player//Music Player//images//pause.gif")
